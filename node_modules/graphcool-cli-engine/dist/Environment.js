...
var Environment = (function () {
    function Environment(out, config) {
        ...
        this.subscriptionURL = function (_a) {
            var region = _a.region, projectId = _a.projectId, localPort = _a.localPort;
            return localPort
    ...
    Environment.prototype.subscriptionEndpoint = function (projectId) {
        ...
        var match = this.clusterEndpoint.match(/.*:(\d+)\/?.*/);
        var localPort = match ? match[1] : '60000';
        return this.subscriptionURL({ localPort: localPort, projectId: projectId });
    };
